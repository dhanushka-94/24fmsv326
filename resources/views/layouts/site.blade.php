...
<head>
    ...
    <link rel="icon" href="{{ asset(config('frames.favicon')) }}" type="image/png">
    <link rel="apple-touch-icon" href="{{ asset(config('frames.favicon')) }}">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=DM+Sans:ital,opsz,wght@0,9..40,300;0,9..40,400;0,9..40,500;1,9..40,400&family=Syne:wght@400;500;600;700;800&display=swap" rel="stylesheet">
